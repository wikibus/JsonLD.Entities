...
Scenario: Deserialize simple resource entity
	Given NQuads:
		...
		<http://example.com/Person> <http://example.com/ontology#dateOfBirth> "12-08-1975" .
		"""
	And @context is:
		"""
		{
	...
	And object should have DateTime property 'BirthDate' equal to '12-08-1975'
